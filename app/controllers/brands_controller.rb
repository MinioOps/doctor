...
class BrandsController < ApplicationController
  ...
  private
    ...
    def brand_params
      params.require(:brand).permit(:title, :logo_url, :description, :tagline, :home_link, :github_link, :gitter_link, :slack_link, :bitbucket_link, :twitter_link, :footer_text, :footer_img, :footer_chatlink, :font_family, :font_size, :text_color, :link_color, :heading_color, :header_background_color, :header_text_color, :sidebar_background_color, :sidebar_link_color, :menu_hover_background_color, :menu_title_color)
    end
end
